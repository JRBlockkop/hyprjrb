...
static inline SDL_Surface *TTF_RenderText_Blended(TTF_Font *font,char *text, int i, SDL_Color color){(void)font;(void)text;(void)i;(void)color;SDL_Surface *s = malloc(sizeof(SDL_Surface));s->text = text;s->color = color;return s;}
